						...
						{mostPlayed.map(({ map, played }) => (
							<div key={map} className="row space-between center-y underlined">
								...
								<div className="row nogap nowrap full-width" style={{ width: '70px' }}>
									<div style={{ height: '3px', backgroundColor: "#3A74FA",   width: `${(played / totalPlayed * 100)}%` }}></div>
									<div style={{ height: '3px', backgroundColor: "transparent", width: `${((totalPlayed - played) / totalPlayed * 100)}%` }}></div>
								</div>
