...
On the player profile page, CSStats Plus adds the following features:
...
Kill/Death and HLTV donuts charts:
- Improved visualization of both charts, making it easier to understand player performance.
